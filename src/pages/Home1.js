      ...
      <div className="spacer-new-home">
        ...
        <section className="wcat-home1">
          ...
          <div className="wcat-grid-home1">
            <div className="wcat-card-home1">
              ...
              <div className="wcat-info-home1">
                ...
                <Link to="/women" className="wcat-buy-home1">Buy Now</Link>
              </div>
            </div>
          ...
          <div className="wcat-more-home1">
            <Link to="/women" className="wcat-view-home1">View More</Link>
          </div>
        </section>
        ...
        <section className="aurum-women">
          <div className="aurum-shell">
            <div className="aurum-head">
              ...
              <a className="aurum-viewall" href="/women">View all</a>
            </div>
            ...
            <div className="aurum-grid">
              <a href="/women" className="aurum-card">
                <div className="aurum-imgwrap">
                  <img
                    src="/images/women/new/category12.png"
              ...
              <a href="/women" className="aurum-card">
                <div className="aurum-imgwrap">
                  <img
                    src="/images/women/new/category9.png"
              ...
              <a href="/women" className="aurum-card">
                <div className="aurum-imgwrap">
                  <img
                    src="/images/women/new/category10.png"
              ...
              <a href="/women" className="aurum-card">
                <div className="aurum-imgwrap">
                  <img
                    src="/images/women/new/category11.png"
              ...
              <a href="/women" className="aurum-card">
                <div className="aurum-imgwrap">
                  <img
                    src="/images/women/new/category13.png"
              ...
              <a href="/women" className="aurum-card">
                <div className="aurum-imgwrap">
                  <img
                    src="/images/women/new/category14.png"
              ...
              <a href="/women" className="aurum-card">
                <div className="aurum-imgwrap">
                  <img
                    src="/images/women/new/category15.png"
              ...
              <a href="/women" className="aurum-card">
                <div className="aurum-imgwrap">
                  <img
                    src="/images/women/new/category16.png"
        ...
        <section className="wb2-sec-home1">
          <div className="wb2-head-home1">
            ...
            <Link to="/women?brand=Twin%20Birds" className="wb2-view-home1">View All</Link>
          </div>

          <div className="wb2-grid-home1">
            <Link to="/women" className="wb2-card-home1">
              <img src="/images/women/new/category-1.png" alt="Kurti Pants" className="wb2-img-home1" />
              <span className="wb2-tag-home1">Kurti Pants</span>
            </Link>

            <Link to="/women" className="wb2-card-home1">
              <img src="/images/women/new/category-2.png" alt="Leggings" className="wb2-img-home1" />
              <span className="wb2-tag-home1">Leggings</span>
            </Link>

            <Link to="/women" className="wb2-card-home1">
              <img src="/images/women/new/category-3.png" alt="Lounge Wear" className="wb2-img-home1" />
              <span className="wb2-tag-home1">Lounge Wear</span>
            </Link>

            <Link to="/women" className="wb2-card-home1">
              <img src="/images/women/new/category-4.png" alt="Shapers" className="wb2-img-home1" />
              <span className="wb2-tag-home1">Shapers</span>
            </Link>

            <Link to="/women" className="wb2-card-home1">
              <img src="/images/women/new/category-5.png" alt="Straight Pants" className="wb2-img-home1" />
              <span className="wb2-tag-home1">Straight Pants</span>
            </Link>

            <Link to="/women" className="wb2-card-home1">
              <img src="/images/women/new/category-6.png" alt="T-Shirts" className="wb2-img-home1" />
              <span className="wb2-tag-home1">T-Shirts</span>
            </Link>

            <Link to="/women" className="wb2-card-home1">
              <img src="/images/women/new/category-7.png" alt="Tops" className="wb2-img-home1" />
              <span className="wb2-tag-home1">Tops</span>
            </Link>

            <Link to="/women" className="wb2-card-home1">
              <img src="/images/women/new/category-8.png" alt="Kids" className="wb2-img-home1" />
              <span className="wb2-tag-home1">Kids</span>
            </Link>
          </div>

          <div className="wb2-pills-home1">
            <Link to="/women" className="wb2-pill-home1">Cotton Kurti</Link>
            <Link to="/women" className="wb2-pill-home1">Flexi Kurti Pant</Link>
            <Link to="/women" className="wb2-pill-home1">Sleek Kurti Pant</Link>
            <Link to="/women" className="wb2-pill-home1">Viscose Kurti Pant</Link>
          </div>
        </section>
          ...
          <div className="wb3-belt">
            <div className="wb3-track">
              <Link to="/women" className="wb3-item">
                <img src="/images/women/new/category9.png" alt="Kurti Pants" />
                <span className="wb3-tag">Kurti Pants</span>
              </Link>
              <Link to="/women" className="wb3-item">
                <img src="/images/women/new/category10.png" alt="Leggings" />
                <span className="wb3-tag">Leggings</span>
              </Link>
              <Link to="/women" className="wb3-item">
                <img src="/images/women/new/category11.png" alt="Lounge Wear" />
                <span className="wb3-tag">Lounge Wear</span>
              </Link>
              <Link to="/women" className="wb3-item">
                <img src="/images/women/new/category12.png" alt="Shapers" />
                <span className="wb3-tag">Shapers</span>
              </Link>
              <Link to="/women" className="wb3-item">
                <img src="/images/women/new/category13.png" alt="Straight Pants" />
                <span className="wb3-tag">Straight Pants</span>
              </Link>
              <Link to="/women" className="wb3-item">
                <img src="/images/women/new/category14.png" alt="T-Shirts" />
            ...
            <div className="wb3-track wb3-track-rev">
              <Link to="/women" className="wb3-item">
                <img src="/images/women/new/category-1.png" alt="Tops" />
                <span className="wb3-tag">Tops</span>
              </Link>
              <Link to="/women" className="wb3-item">
                <img src="/images/women/new/category-2.png" alt="Kids" />
                <span className="wb3-tag">Kids</span>
              </Link>
              <Link to="/women" className="wb3-item">
                <img src="/images/women/new/category-3.png" alt="Viscose Kurti Pant" />
                <span className="wb3-tag">Viscose Kurti Pant</span>
              </Link>
              <Link to="/women" className="wb3-item">
                <img src="/images/women/new/category-4.png" alt="Viscose Leggings" />
                <span className="wb3-tag">Viscose Leggings</span>
              </Link>
              <Link to="/women" className="wb3-item">
                <img src="/images/women/new/category-5.png" alt="Co-Ord Sets" />
                <span className="wb3-tag">Co-Ord Sets</span>
              </Link>
              <Link to="/women" className="wb3-item">
                <img src="/images/women/new/category-6.png" alt="Saree Shaper" />
        ...
        <section className="home1-hero-new-home-2">
          <div className="home1-hero-frame-new-home-2">
            ...
            >
              <SwiperSlide>
                <div className="home1-hero-slide-new-home-2">
                  <img src="/images/banners/banner4.png" alt="Women Banner" loading="eager" />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className="home1-hero-slide-new-home-2">
                  <img src="/images/banners/banner5.png" alt="Women Banner" loading="lazy" decoding="async" />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className="home1-hero-slide-new-home-2">
                  <img src="/images/banners/banner6.png" alt="Women Banner" loading="lazy" decoding="async" />
                </div>
              </SwiperSlide>
            </Swiper>
          </div>
        ...
        <section className="wb4-sec">
          <div className="wb4-head">
            ...
            <Link to="/women" className="wb4-view">View All</Link>
          </div>

          <div className="wb4-mag">
            <div className="wb4-col">
              <Link to="/women" className="wb4-card">
                <img src="/images/women/new/zig-zag1.png" alt="Tops" />
                <span className="wb4-label">Tops</span>
              </Link>
              <Link to="/women" className="wb4-card">
                <img src="/images/women/new/zig-zag2.png" alt="Leggings" />
            ...
            <div className="wb4-col wb4-col-center">
              <Link to="/women" className="wb4-card wb4-card-tall">
                <img src="/images/women/new/zig-zag3.png" alt="Kurti Pants" />
            ...
            <div className="wb4-col">
              <Link to="/women" className="wb4-card">
                <img src="/images/women/new/zig-zag4.png" alt="Lounge Wear" />
                <span className="wb4-label">Lounge Wear</span>
              </Link>
              <Link to="/women" className="wb4-card">
                <img src="/images/women/new/zig-zag5.png" alt="Straight Pants" />
          ...
          <div className="wb4-chips">
            <Link to="/women" className="wb4-chip">T-Shirts</Link>
            <Link to="/women" className="wb4-chip">Casual Shirt</Link>
            <Link to="/women" className="wb4-chip">Viscose Leggings</Link>
            <Link to="/women" className="wb4-chip">Cotton Kurti</Link>
          </div>
        </section>
        ...
        <section className="wb5-sec">
          <div className="wb5-head">
            ...
            <Link to="/women" className="wb5-view">View All</Link>
          </div>
          ...
          <div className="wb5-grid">
            <Link to="/women" className="wb5-card wb5-tall">
              ...
              <div className="wb5-info">
                ...
                <div className="wb5-row">
                  ...
                  <span className="wb5-price"><span className="wb5-strike">₹1,299</span> ₹1,039</span>
                </div>
              </div>
            </Link>
            ...
            <Link to="/women" className="wb5-card">
              ...
              <div className="wb5-info">
                ...
                <div className="wb5-row">
                  ...
                  <span className="wb5-price"><span className="wb5-strike">₹1,499</span> ₹1,049</span>
                </div>
              </div>
            </Link>
            ...
            <Link to="/women" className="wb5-card">
              ...
              <div className="wb5-info">
                ...
                <div className="wb5-row">
                  ...
                  <span className="wb5-price"><span className="wb5-strike">₹1,199</span> ₹983</span>
                </div>
              </div>
            </Link>
            ...
            <Link to="/women" className="wb5-card">
              <div className="wb5-imgwrap">
                <img src="/images/women/new/roll4.png" alt="Co-ord Sets" />
              </div>
              <div className="wb5-info">
                <div className="wb5-row">
                  <span className="wb5-brand">Intimacy</span>
                ...
                <div className="wb5-row">
                  ...
                  <span className="wb5-price"><span className="wb5-strike">₹1,799</span> ₹1,349</span>
                </div>
              </div>
            </Link>
            ...
            <Link to="/women" className="wb5-card wb5-wide">
              ...
              <div className="wb5-info">
                ...
                <div className="wb5-row">
                  ...
                  <span className="wb5-price"><span className="wb5-strike">₹1,999</span> ₹1,439</span>
                </div>
              </div>
            </Link>
            ...
            <Link to="/women" className="wb5-card">
              ...
              <div className="wb5-info">
                ...
                <div className="wb5-row">
                  ...
                  <span className="wb5-price"><span className="wb5-strike">₹1,099</span> ₹857</span>
                </div>
              </div>
            </Link>
            ...
            <Link to="/women" className="wb5-card">
              ...
              <div className="wb5-info">
                ...
                <div className="wb5-row">
                  ...
                  <span className="wb5-price"><span className="wb5-strike">₹899</span> ₹764</span>
                </div>
              </div>
            </Link>
            ...
            <Link to="/women" className="wb5-card">
              <div className="wb5-imgwrap">
                <img src="/images/women/new/pin1.jpg" alt="Premium" />
              </div>
              <div className="wb5-info">
                <div className="wb5-row">
                  <span className="wb5-brand">Naidu Hall</span>
                ...
                <div className="wb5-row">
                  ...
                  <span className="wb5-price"><span className="wb5-strike">₹2,199</span> ₹1,495</span>
                </div>
              </div>
            </Link>
            ...
            <Link to="/women" className="wb5-card">
              <div className="wb5-imgwrap">
                <img src="/images/women/new/roll8.jpg" alt="Basics" />
              </div>
              <div className="wb5-info">
                <div className="wb5-row">
                  <span className="wb5-brand">Intimacy</span>
            ...
            <Link to="/women" className="wb5-card">
              <div className="wb5-imgwrap">
                <img src="/images/women/new/roll1.png" alt="Premium" />
              </div>
              <div className="wb5-info">
                <div className="wb5-row">
                  <span className="wb5-brand">Naidu Hall</span>
        ...
        <section className="mb1-sec">
          ...
          <div className="mb1-circles">
            <Link to="/men" className="mb1-item">
              ...
              <img src="/images/men/men-ct-1.png" alt="Shirts" />
              <span className="mb1-cap">Shirts</span>
            </Link>

            <Link to="/men" className="mb1-item">
              <span className="mb1-ring"></span>
              <img src="/images/men/men-ct-2.png" alt="T-Shirts" />
              <span className="mb1-cap">T-Shirts</span>
            </Link>

            <Link to="/men" className="mb1-item">
              <span className="mb1-ring"></span>
              <img src="/images/men/men-ct-3.png" alt="Trousers" />
              <span className="mb1-cap">Trousers</span>
            </Link>

            <Link to="/men" className="mb1-item">
              <span className="mb1-ring"></span>
              <img src="/images/men/men-ct-4.png" alt="Denim" />
              <span className="mb1-cap">Denim</span>
            </Link>

            <Link to="/men" className="mb1-item">
              <span className="mb1-ring"></span>
              <img src="/images/men/men-ct-5.png" alt="Ethnic Wear" />
              <span className="mb1-cap">Ethnic Wear</span>
            </Link>

            <Link to="/men" className="mb1-item">
              <span className="mb1-ring"></span>
              <img src="/images/men/men-ct-6.png" alt="Winter" />
              <span className="mb1-cap">Winter</span>
            </Link>

            <Link to="/men" className="mb1-item">
              <span className="mb1-ring"></span>
              <img src="/images/men/men-ct-7.png" alt="Footwear" />
              <span className="mb1-cap">Footwear</span>
            </Link>

            <Link to="/men" className="mb1-item">
              <span className="mb1-ring"></span>
              <img src="/images/men/men-ct-5.png" alt="Accessories" />
        ...
        <section className="home1-hero-new-home-2">
          <div className="home1-hero-frame-new-home-2">
            ...
            >
              <SwiperSlide>
                <div className="home1-hero-slide-new-home-2">
                  <img src="/images/banners/banner7.png" alt="Women Banner" loading="eager" />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className="home1-hero-slide-new-home-2">
                  <img src="/images/banners/banner8.png" alt="Women Banner" loading="lazy" decoding="async" />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className="home1-hero-slide-new-home-2">
                  <img src="/images/banners/banner9.png" alt="Women Banner" loading="lazy" decoding="async" />
                </div>
              </SwiperSlide>
            </Swiper>
          </div>
